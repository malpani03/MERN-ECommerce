...
const Logo = () => {
  return (
    <svg width="50px" height="39px" viewBox="0 0 50 39" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <title>Group</title>
        ...
        <g id="WiP" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Artboard" transform="translate(-90.000000, -38.000000)">
                <g id="Group" transform="translate(90.000000, 38.000000)">
                    ...
                    <polygon id="Triangle" fillOpacity="0.262838724" fill="#101A1A" points="25 8 40 39 10 39"></polygon>
